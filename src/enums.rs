...
define_enum!(
    ...
    Stopping = libvlc_state_t_libvlc_Stopping,
...
define_enum!(
    ...
    MediaThumbnailGenerated = libvlc_event_e_libvlc_MediaThumbnailGenerated,
    MediaAttachedThumbnailsFound = libvlc_event_e_libvlc_MediaAttachedThumbnailsFound,
    ...
    MediaPlayerStopping = libvlc_event_e_libvlc_MediaPlayerStopping,
    ...
    MediaPlayerESAdded = libvlc_event_e_libvlc_MediaPlayerESAdded,
    MediaPlayerESDeleted = libvlc_event_e_libvlc_MediaPlayerESDeleted,
    MediaPlayerESSelected = libvlc_event_e_libvlc_MediaPlayerESSelected,
    MediaPlayerCorked = libvlc_event_e_libvlc_MediaPlayerCorked,
    MediaPlayerUncorked = libvlc_event_e_libvlc_MediaPlayerUncorked,
    MediaPlayerMuted = libvlc_event_e_libvlc_MediaPlayerMuted,
    MediaPlayerUnmuted = libvlc_event_e_libvlc_MediaPlayerUnmuted,
    MediaPlayerAudioVolume = libvlc_event_e_libvlc_MediaPlayerAudioVolume,
    MediaPlayerAudioDevice = libvlc_event_e_libvlc_MediaPlayerAudioDevice,
    MediaPlayerESUpdated = libvlc_event_e_libvlc_MediaPlayerESUpdated,
    MediaPlayerProgramAdded = libvlc_event_e_libvlc_MediaPlayerProgramAdded,
    MediaPlayerProgramDeleted = libvlc_event_e_libvlc_MediaPlayerProgramDeleted,
    MediaPlayerProgramSelected = libvlc_event_e_libvlc_MediaPlayerProgramSelected,
    MediaPlayerProgramUpdated = libvlc_event_e_libvlc_MediaPlayerProgramUpdated,
    MediaPlayerTitleListChanged = libvlc_event_e_libvlc_MediaPlayerTitleListChanged,
    MediaPlayerTitleSelectionChanged = libvlc_event_e_libvlc_MediaPlayerTitleSelectionChanged,
    MediaPlayerChapterChanged = libvlc_event_e_libvlc_MediaPlayerChapterChanged,
    MediaPlayerRecordChanged = libvlc_event_e_libvlc_MediaPlayerRecordChanged,
    MediaPlayerTeletextPageChanged = libvlc_event_e_libvlc_MediaPlayerTeletextPageChanged,
    MediaPlayerTeletextActivePageChanged = libvlc_event_e_libvlc_MediaPlayerTeletextActivePageChanged,
    ...
    MediaListEndReached = libvlc_event_e_libvlc_MediaListEndReached,
    ...
    RendererDiscovererItemAdded = libvlc_event_e_libvlc_RendererDiscovererItemAdded,
    RendererDiscovererItemDeleted = libvlc_event_e_libvlc_RendererDiscovererItemDeleted,
    MediaPlayerMediaStopping = libvlc_event_e_libvlc_MediaPlayerMediaStopping,
);
